...
export function getWeb3(
  ...
  if (window.web3) return new ethers.providers.Web3Provider(window.web3.currentProvider);
  return undefined;
}

export const Web3Context = React.createContext<{
  web3: ethers.providers.Web3Provider | ethers.providers.JsonRpcProvider | undefined;
...
const Web3Provider: React.FC<{}> = ({ children }) => {
  ...
  return (
    <Web3Context.Provider value={{ web3, alchemy, connectedToChain, settingChain }}>
      {children}
