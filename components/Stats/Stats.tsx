    ...
    <div className="flex flex-col justify-center items-center gap-6">
      ...
      {stats.loading ? (
        ...
        <>
          ...
          <div
            key={"score"}
            className="px-4 py-5 w-full bg-white text-center shadow rounded-lg overflow-hidden sm:p-6"
          >
            <dt className="text-sm font-medium text-gray-500 truncate">
              Your score
            </dt>
            <dd className="mt-1 text-3xl font-semibold text-gray-900">{stats.score}</dd>
          </div>
        </>
      )}
    </div>
