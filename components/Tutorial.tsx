      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="text-lg max-w-prose mx-auto">
          ...
          <p className="mt-12 text-xl text-gray-500 leading-8">
            ...
            to 0. Altough it resets the linked value, some properties raise their value (eg. Playing with Eboogotchi will raise his Hunger, Tiredness and Dirtiness).
            It is still unknown why this score
            exists, but I&apos;m sure it has a specific purpose.
          </p>
        </div>
      </div>
    </div>
